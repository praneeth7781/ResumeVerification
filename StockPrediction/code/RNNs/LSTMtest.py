...
from LSTM import MYLSTM, make_dataset, train, predict, INPUT, PRED, EPOCHS, HIDDEN, WINDOW
...
def compute_loss_1day(model_stock,model_yr,test_stock,test_yrs = [2007,2022], micro = False):
    ...
    Ypred = predict('./MODELS/LSTM_{}_{}.pkl'.format(model_stock,model_yr),X_test).detach()
