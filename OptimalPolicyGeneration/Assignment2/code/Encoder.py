                    ...
                    if ((ballsNew%6 != 0 and scored%2 == 1) or (ballsNew%6 == 0 and scored%2 == 0)):
                        ...
                        for B in range(ballsNew, 0, -1):
                            ...
                            if (ballsNewer == 0):
                                ...
                                if (ballsNewer%6 == 0):
                                    transitions.append((i, j, mapStrToState[makeState(ballsNewer, runsNew)], 0, prob*((1-q)/2)))
                                    if (runsNew > 1):
                                        runsNew -= 1
                                    else :
                                        break
                                    ...
                                    if (runsNew > 1):
                                        transitions.append((i, j, mapStrToState[makeState(ballsNewer, runsNew-1)], 0, prob*((1-q)/2)))
                            prob *= ((1-q)/2)
                    else :
